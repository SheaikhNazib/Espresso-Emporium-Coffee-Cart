    ...
    return (
        <div className='mt-32 flex justify-around items-center ' style={{
            ...
            <div>
                ...
                <input className='px-3 py-2 mb-3' type="text" name="name" placeholder='Name' id="" /> <br />
                <input className='px-3 py-2 mb-3' type="email" name="email" placeholder='Email' id="" /> <br />
                <input className='px-3 py-2 mb-3' type="text" name="message" placeholder='Message' id="" /> <br />
